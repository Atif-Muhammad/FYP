...
import { ChevronDown, Pencil, Trash2, Star } from "lucide-react";
import AwardModal from "../models/AwardsModal";

function AwardCard({ achievement, onUpdate, onDelete }) {
  ...
  return (
    <>
      <div
        ...
        onMouseEnter={(e) => {
          e.currentTarget.style.boxShadow = "0 4px 12px rgba(212,175,55,0.18)";
        }}
        onMouseLeave={(e) => {
          ...
          >
            ...
            <div className="min-w-0">
              <p className="font-semibold text-sm truncate" style={{ color: "var(--color-text-primary)" }}>
                {achievement?.title || "Untitled Award"}
              </p>
