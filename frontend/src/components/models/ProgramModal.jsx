        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="Program title" required className="fyp-input"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Program description" rows="5"
          ...
          <div
            ...
            style={{
              border: dragActive ? "2px dashed var(--color-fyp-green)" : "2px dashed var(--color-border)",
              background: dragActive ? "rgba(1,68,33,0.04)" : "transparent",
            }}
          ...
          >
            {preview ? (
              ...
              <div className="flex flex-col items-center gap-2" style={{ color: "var(--color-text-muted)" }}>
                <ImagePlus size={36} style={{ color: "var(--color-fyp-green)" }} />
          ...
          >
            ...
            {loading ? "Submitting…" : program ? "Update Program" : "Create Program"}
          </button>
        </form>
      </div>
    </div>
